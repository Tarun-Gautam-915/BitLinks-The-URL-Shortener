...
const Shorten = () => {
    ...
    return (
        <div className='flex flex-col gap-4 mx-auto max-w-lg bg-purple-100 rounded-lg my-16 p-8'>
            ...
            <button onClick={generate} className='bg-purple-500 font-bold px-3 py-1 rounded-lg shadow-2xl text-white cursor-pointer my-3 active:scale-95'>Generate</button>
